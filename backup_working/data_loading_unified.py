...
def create_data_loading_pipeline(
    ...
    Supports both single and multi-table modes transparently.
    """
    return Pipeline([
        node(
            func=lambda p: load_data_auto(p),
...
if __name__ == "__main__":
    print("✅ Unified data loader ready!")
    print("   Supports single-table and multi-table modes")
    print("   Configure in parameters.yml with 'mode' setting")
